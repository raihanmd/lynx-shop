...
export default function ProductDetails({ product }) {
  ...
  return (
    <>
      ...
      <MobileBookingCard product={product} quantity={quantity} handleQuantityChange={handleQuantityChange} handleIncrement={handleIncrement} handleDecrement={handleDecrement} />
    </>
  );
}
